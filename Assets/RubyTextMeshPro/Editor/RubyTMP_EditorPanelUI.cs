...
namespace TMPro.EditorUtilities
{
    ...
    {
        //Labels and Tooltips
        private static readonly GUIContent RTL_TOGGLE_LABEL = new GUIContent(
            "Enable RTL Editor",
            "Reverses text direction and allows right to left editing."
        );
        private static readonly GUIContent STYLE_LABEL = new GUIContent(
            "Text Style",
        ...
        protected void DrawRubyTextInput()
        {
            ...
            GUI.Label(
                rect,
                new GUIContent("<b>Ruby Text Input</b>"),
            ...
            else
            {
                ...
                this.m_IsRightToLeftProp.boolValue = EditorGUI.Toggle(
                    new Rect(rect.width - 120, rect.y + 3, 130, 20),
                    RubyTMP_EditorPanelUI.RTL_TOGGLE_LABEL,
                    this.m_IsRightToLeftProp.boolValue
                );
                ...
                if (this.m_IsRightToLeftProp.boolValue)
                {
                    ...
                    this.m_RtlText = EditorGUILayout.TextArea(
                        this.m_RtlText,
                        TMP_UIStyleManager.wrappingTextArea,
                        GUILayout.Height(
                            EditorGUI.GetPropertyHeight(this.m_TextProp)
                ...
                if (this.m_StyleNames != null)
                {
                    ...
                    this.m_TextStyleIndexLookup.TryGetValue(
                        this.m_TextStyleHashCodeProp.intValue,
                        out this.m_StyleSelectionIndex
                    );

                    EditorGUI.BeginChangeCheck();
                    this.m_StyleSelectionIndex = EditorGUI.Popup(
                        rect,
                        RubyTMP_EditorPanelUI.STYLE_LABEL,
                        this.m_StyleSelectionIndex,
                        this.m_StyleNames
                    );

                    if (EditorGUI.EndChangeCheck())
                    {
                        this.m_TextStyleHashCodeProp.intValue = this.m_Styles[
                            this.m_StyleSelectionIndex
                        ].hashCode;
                ...
                EditorGUILayout.SelectableLabel(
                    this.m_TextProp.stringValue,
                    EditorStyles.textArea,
                    GUILayout.Height(
                        EditorGUI.GetPropertyHeight(this.uneditedText)
                            - EditorGUIUtility.singleLineHeight
                    ),
