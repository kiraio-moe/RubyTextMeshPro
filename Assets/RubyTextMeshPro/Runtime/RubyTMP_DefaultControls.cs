...
namespace TMPro
{
    public static class RubyTMP_DefaultControls
    {
        ...
        private static readonly Vector2 THICK_ELEMENT_SIZE = new Vector2(
            RubyTMP_DefaultControls.WIDTH,
            RubyTMP_DefaultControls.THICK_HEIGHT
        );
        ...
        private static readonly Color TEXT_COLOR = new Color(
            50f / 255f,
            50f / 255f,
            50f / 255f,
            1f
        ...
        {
            GameObject buttonRoot = RubyTMP_DefaultControls.CreateUIElementRoot(
                "Button",
                RubyTMP_DefaultControls.THICK_ELEMENT_SIZE
            );
        ...
        {
            GameObject go = RubyTMP_DefaultControls.CreateUIElementRoot(
                "Text (RubyTMP)",
                RubyTMP_DefaultControls.THICK_ELEMENT_SIZE
            );
